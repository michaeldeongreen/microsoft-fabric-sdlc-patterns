...
- **Default technical terms to English.** Fabric item types and portal feature names stay in English even in prose — *Lakehouse*, *Notebook*, *Semantic Model*, *Variable Library*, *Data Pipeline*, *Data Agent*, *Ontology*, *Branch Out*, *Deployment Pipelines*. A literally translated technical term is usually less recognizable than the original. Translate only firmly established equivalents (*branch* → rama, *workspace* → área de trabajo).
